...
Этот каталог содержит решения задач контрольной работы 
по дисциплине процедурное программирование. Позже я подробнее распишу все файлы или прикреплю pdf или что-то подобное.
